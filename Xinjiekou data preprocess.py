...
def build_scene_grid(is_north):
    ...
    corners = [[5.52, 0], [8.12, 0], [5.52, 6], [8.12, 6],
               [5.52, 38.8], [8.12, 38.8], [5.52, 44.8], [8.12,44.8],
               [5.52,86.44], [8.12,86.44], [5.52, 92.44], [8.12, 92.44],
               [5.52, 124.04], [8.12, 124.04], [5.52, 130.04], [8.12, 130.04]]
